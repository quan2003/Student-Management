...
namespace StudentManagement.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater {
    ...
    private PermissionPolicyRole CreateDefaultRole() {
        PermissionPolicyRole defaultRole = ObjectSpace.FirstOrDefault<PermissionPolicyRole>(role => role.Name == "SinhVien21IT509");
        if(defaultRole == null) {
            defaultRole = ObjectSpace.CreateObject<PermissionPolicyRole>();
            defaultRole.Name = "SinhVien21IT509";
